...
- Solver framework: `Solver`/`BracketingSolver` base classes with flop counting, an evaluation budget, and guards against diverging steps and non-finite function values
