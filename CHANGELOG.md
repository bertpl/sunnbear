...
- Solver framework: every solver's function evaluations run through one wrapper that applies an evaluation budget, guards against diverging steps and non-finite values, and flop counting
