...
from sunnbear._core.builtin_artifact_listing import artifact_manifest, artifact_names
...
def test_artifact_names_lists_builtin_declarations_only():
...
@pytest.mark.usefixtures("isolated_artifact_registry")
def test_artifact_manifest_reads_the_manifest_of_a_builtin_artifact(monkeypatch, tmp_path):
