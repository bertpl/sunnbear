...
@pytest.mark.parametrize(
    "solver_kwargs, solver_id_expected",
    [
    ...
    config_cls = define_config(
        {
            ...
            "solver_kwargs": {"weight": 0.25, "n_warmup": 3},
            "role": SolverRole.USER_ACTIVE,
        }
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"solver_cls": WeightedSplitSolver, "solver_kwargs": {"weight": 0.5}}, "must define role"),
        ...
        (
            {
                "solver_cls": WeightedSplitSolver,
                "solver_kwargs": {"weight": 0.5, "slack": 1},
                "role": SolverRole.USER_ACTIVE,
            },
            "unexpected keyword argument 'slack'",
        ),
        (
            {"solver_cls": WeightedSplitSolver, "solver_kwargs": {"weight": [0.5]}, "role": SolverRole.USER_ACTIVE},
            r"solver_kwargs\['weight'\] must be a bool, int, float, or str",
        ),
    ],
)
